...
<div class="flex justify-center ">
<a href="<?php echo e(route('menu')); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
    Menu
</a>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\boki\Documents\github\Laravel-1\example-app\resources\views/home.blade.php ENDPATH**/ ?>